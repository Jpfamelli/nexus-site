...
(function () {
  ...
  var BASE = [
    ...
    },
    {
      ...
      resposta: "Site no ar em **5 dias** no pacote Essencial e **9 dias** no Crescimento. A IA no WhatsApp fica ativa em até 10 dias, e a proposta chega em 24 horas depois da nossa conversa.\n\nSe você tem uma data apertada, me conta qual é que a gente vê o que dá para priorizar.",
      sugestoes: ["Quanto custa?", "Quero agendar o diagnóstico"]
    },
    {
      id: "ia",
      gatilhos: ["ia", "inteligencia artificial", "inteligência", "automacao", "automação", "robo", "robô", "bot", "atendente", "atendimento automatico", "chatbot", "responde sozinho"],
      resposta: "É exatamente o que você está usando agora 🙂\n\nA IA fica no **seu** WhatsApp e: responde na hora as perguntas que se repetem todo dia, coleta nome e o que a pessoa precisa, agenda sem trocar vinte mensagens, retoma orçamento parado e passa a conversa para uma pessoa quando sai do combinado.\n\nEla é treinada só com as informações que você aprovar — nada inventado.",
    ...
    {
      id: "anuncios",
      gatilhos: ["anuncio", "anúncio", "trafego", "tráfego", "ads", "google ads", "impulsionar", "patrocinado", "campanha"],
      resposta: "Gestão de anúncios no Google ou Instagram por **R$ 1.490/mês** + a verba de mídia que você definir. Entra configuração da campanha, ajustes semanais e um relatório mensal direto — sem relatório de cinquenta páginas.",
      sugestoes: ["Quanto custa?", "Quero agendar o diagnóstico"]
    },
    {
      id: "sistema",
      gatilhos: ["sistema", "planilha", "painel", "crm", "gestao", "gestão", "software", "programa", "sob medida"],
      resposta: "Quando a planilha e o grupo de mensagens já não dão conta, montamos um fluxo mais simples: painéis para acompanhar pedidos, cadastros organizados, tarefas que rodam sem cobrança manual e as ferramentas conversando entre si.\n\nProjeto a partir de **R$ 6.900**, com treinamento da equipe incluso.",
      sugestoes: ["Quanto custa?", "Quero agendar o diagnóstico"]
    },
    {
      id: "avulso",
    ...
    },
    {
      ...
      resposta: "**Essencial** (R$ 3.500 + R$ 590/mês): site de 5 páginas, Google Perfil da Empresa, IA no WhatsApp, 8 vídeos curtos por mês e suporte.\n\n**Crescimento** (R$ 5.000 + R$ 990/mês): tudo do Essencial + agendamento e cobrança automáticos, 16 peças de social media, uma diária de gravação por mês, identidade visual e relatório mensal.\n\n**Ultra** (R$ 9.900 + R$ 1.890/mês): tudo do Crescimento + anúncios gerenciados, recuperação de orçamento parado, sistema sob medida com painel, 2 diárias por mês, 24 peças, vídeo institucional e reunião estratégica.\n\nA mensalidade é o acompanhamento: revisamos o uso, corrigimos atritos e ajustamos conforme a empresa muda.",
    ...
    {
      id: "regiao",
      gatilhos: ["onde", "regiao", "região", "cidade", "taubate", "taubaté", "vale do paraiba", "presencial", "distancia", "distância", "atende", "atendem", "pindamonhangaba", "sao jose", "são josé", "jacarei", "jacareí", "caraguatatuba", "ubatuba", "guaratingueta", "guaratinguetá", "tremembe", "tremembé", "outra cidade", "fora daqui", "meu estado", "online"],
      resposta: "Somos de **Taubaté** e atendemos todo o Vale do Paraíba. Projetos à distância também rolam numa boa — só as gravações presenciais fora da região precisam de um alinhamento de logística antes.",
    ...
    {
      id: "projetos",
      gatilhos: ["projeto", "portfolio", "portfólio", "exemplo", "trabalho", "case", "ver site", "indycar", "prado", "eletronic", "iphone", "clientes"],
      resposta: "Três que estão no ar agora:\n\n• **IndyCar Centro Automotivo** — site + agendamento + esta IA respondendo no WhatsApp\n• **Prado Moda Social** — catálogo com sacola e fechamento direto no WhatsApp\n• **Eletronic** — boutique de iPhones com catálogo em tempo real integrado ao estoque e clube de vantagens\n\nNa seção Projetos do site você clica e abre os três para ver funcionando.",
...
,
    ...
    {
      id: "garantia",
      gatilhos: ["e se eu nao gostar", "tem garantia", "e se não funcionar", "se der errado", "e se nao der certo", "posso desistir", "devolve o dinheiro", "reembolso", "garantia de resultado", "e se o site ficar feio", "e se eu não gostar do layout", "vcs garantem", "qual a garantia", "e se eu nao aprovar", "posso testar antes", "vcs garantem cliente"],
      resposta: "Nada vai pro ar sem o seu sim. Você aprova o layout antes de a gente programar, então \"não gostei\" vira ajuste, não prejuízo.\n\nO que eu garanto é entrega no prazo combinado (**5 dias** no Essencial, **9 dias** no Crescimento) e conserto do que sair fora do que foi acordado, sem cobrar de novo. Volume de venda ninguém honesto garante — quem garante está vendendo ilusão.\n\nA mensalidade você avalia mês a mês. Quer ver como funciona antes de decidir? O diagnóstico é gratuito.",
    ...
    },
    {
      ...
      resposta: "Sim. O foco da Nexus é negócio local de serviço e varejo: oficina, loja, assistência técnica, clínica, prestador de serviço.\n\nDois exemplos no ar agora: **IndyCar Centro Automotivo** (oficina) e **Prado Moda Social** (moda masculina). Ramos bem diferentes, mesma engrenagem — aparecer no Google, responder rápido no WhatsApp e agendar sem depender de alguém livre pra digitar.\n\nMe conta qual é o seu ramo. Se não fizer sentido pro seu caso, eu falo na hora.",
    ...
    {
      id: "agenda-integra",
      gatilhos: ["ela agenda", "agenda na minha agenda", "google agenda", "google calendar", "integra com minha agenda", "marca horario sozinha", "ela marca horario", "agendamento automatico", "vai bater com minha agenda", "conflito de horario", "dois clientes no mesmo horario", "marcar consulta", "marca no meu calendario", "horario ocupado", "agenda automatica"],
...
,
  ...
  var VAZIAS = {
    ...
    ser: 1, sao: 1, esta: 1, estao: 1, vai: 1, vou: 1, fica: 1, faz: 1, fazer: 1,
  ...
  function responder(pergunta) {
    ...
    for (var i = 0; i < BASE.length; i++) {
      ...
      for (var g = 0; g < item.gatilhos.length; g++) {
        ...
        if (acertos === gPal.length && gPal.length > 1) {
          nota = Math.max(nota, 12 * gPal.length + peso);
        } else if (acertos > 0) {
